          ...
          <div className="panel-content">
            <div className="ai-chat-preview">
              ...
              <div className="ai-intro">
                <h4>CSSC AI Assistant</h4>
                <p>Get help with finding information or answering questions about CSSC activities.</p>
                <button
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (storedUserData) {
          ...
          if (userDetails) {
            setCurrentUser({
              name: userDetails.name || 'CSSC Member',
    ...
    <div className="acss-dashboard">
      ...
      <div className="sidebar">
        <div className="logo-container">
          ...
          <div className="logo-placeholder">CSSC</div>
          <h2>CSSC</h2>
        </div>
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            <p className="user-name">{currentUser.name || 'CSSC Member'}</p>
...
const CsscStudent = () => {
  return (
    <Router>
      <Routes>
        <Route path="/" element={<CsscStudentContent />} />
      </Routes>
    </Router>
  );
};

export default CsscStudent;